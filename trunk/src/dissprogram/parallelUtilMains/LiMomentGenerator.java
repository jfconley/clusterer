 ...
 * @author jconley
 */
public class LiMomentGenerator {
        ...
        public void generateMoments(){
            MomentGenerator mg = new MomentGenerator();
                ...
                for (int step = 0; step < 40; step++){
                    ...
                    mg.setRaster(raster);
                    //calculate moments
                    double[] temp = mg.calculateLiInvariants();
                    ...
                    try{
                        File momentFile = new File("D:/synthLandscan/randomStarts/" + type + "/run" + run + "/GAMLiMoments" + step + ".csv");
